...
<html lang="en">
  ...
  <body>
    <div class="card card-style">
        <div class="card-body">
           <center><h1 class="h1_top">Library  Management  System</h1></center>
        </div>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-3">
            <div class="card border-primary bg-light-blue border-2 mt-3 mx-3 mb-4" style="max-width: 20rem; background: #b2bfdb;">
          ...
          <div class="col-9 p-4">
            <img src="img3.png" style="width: 67%; padding-left: 15%">
          </div>
      </div>
